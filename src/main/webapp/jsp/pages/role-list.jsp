...
<link rel="stylesheet"
	...
	<script>
		function deleteRole(id) {
			if(confirm("您确定要删除吗?")){
				location.href="${pageContext.request.contextPath}/role/delete/" + id;
			}
		}
	</script>
</head>
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
										...
										<c:forEach items="${roleList}" var="role">
											<tr>
												...
												<td class="text-center">
													<a href="javascript:void(0);" class="btn bg-olive btn-xs" onclick="deleteRole('${role.id}')">删除</a>
												</td>
											</tr>
										</c:forEach>
								</tbody>
		...
		<script src="../../WEB-INF/plugins/bootstrap-slider/bootstrap-slider.js"></script>
		<script>
